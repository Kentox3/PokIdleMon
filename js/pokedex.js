...
function renderPokedexScreen() {
  ...
  var dexBallIcon = "<img src='https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/poke-ball.png' class='dex-ball-icon' alt='Pokeball'>";

  var html =
    "<div class='dex-header'>" +
      "<div class='dex-counts'>" +
        "<span class='dex-count-item'>" + dexBallIcon + " <b>" + gefangenAnz + "</b>/151 gefangen</span>" +
  ...
  for (var i = 1; i <= 151; i++) {
    ...
    html +=
      "<div class='" + cls + "' onclick='showDexDetail(" + i + ")'" +
        ...
        (isCaught ? "<div class='dex-pokeball'>" + dexBallIcon + "</div>" : "") +
      "</div>";
  }
